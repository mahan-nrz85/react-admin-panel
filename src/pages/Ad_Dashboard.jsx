          ...
          <div className='grid grid-cols-2 gap-5'>
            ...
            {/* status Cards */}
              <div className='grid grid-cols-3  gap-5 w-[100%]'>
                ...
                <div className='users-count w-[100%] h-24 rounded-2xl place-content-center !p-2 text-center bg-[var(--bg-sec)] card-def'>
                  <div className='flex items-center justify-center gap-1'>
                    <span>
                      <DocumentScanner />
                    </span>
            ...
            {/* Top users */}
              <div className='!mt-4 card-def rounded-2xl !p-5 text-2xl '>
            ...
            {/* chart */}
            <div className='overflow-hidden h-[500px] card-def rounded-2xl'>
