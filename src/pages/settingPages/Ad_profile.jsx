...
function Ad_profile() {
 ...
 useEffect(() => {
  ...
  return (
    <>
    <SnackbarProvider>
      <div className='main-container flex items-center justify-center w-full'>
          <div className='main-div bg-[#1A1D1F] w-[80%] rounded-2xl relative h-[300px]'>
              ...
              <div className='flex gap-5 items-end justify-between absolute bottom-10 !p-3 w-full'>
                <div className='flex items-end gap-5'>
                  <img src={'/image/profile.png'} alt='پروفایل' className='w-25 rounded-[9999px]'/>
      ...
      >
        {
          (dialogNum === 1) ?
            ...
            : (
                <div className='flex flex-col items-center'>
                <div className='w-30 h-30 rounded-[9999px] relative flex items-center justify-center' style={{
                  border : '4px dotted gray'
                }}>
                  {
                    (previewFile === null) ?  
